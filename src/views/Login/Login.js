...
const trueEmail = 'login';
const truePassword = 'senha';
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.keyboardView}>
            <TextInput
              ...
              placeholder="Número de telefone, endereço de e-mail ou nome de usuário"
            ...
            <View style={{ alignItems: 'center', padding: 10 }}>
              <View style={styles.text}>
                <Text style={{ fontSize: 12, color: 'grey' }}>
                  Esqueceu seus detalhes de login?{' '}
                </Text>
              ...
              <View style={styles.seperatorStyle}>
                ...
                <Text style={{ color: 'grey' }}> META MONEY </Text>
                <View style={styles.seperator} />
              </View>
          ...
          <View style={styles.bottomContainer}>
            <View style={styles.bottom}>
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={{ ...styles.help, marginTop: 15 }}> Registro.</Text>
              </View>
